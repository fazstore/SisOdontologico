...
<body>
	...
	<div class="container">
        ...
        <table>
        	<tr>
                <td style="width:550px">
                    <h3>   Tratamientos de Pacientes</h3>
                </td>
                <td>
                <form class="navbar-search pull-left" method="post" name="fbuscar" id="fbuscar" action="index.php">
                   <table cellspacing="2">
                      <tr>
                        <td>
        ...
        <div class="row-fluid">
        	<div class="span12">
                <ul class="breadcrumb">
                    <li class="active"><i class="icon-home"></i> Tratamientos Pecientes</li>
                </ul>
			</div>
		...
		<div class="portlet-body">
			<div class="row-fluid">
				<div class="alert alert-info">
					<h4><i class="icon-list"></i> Pacientes<span class="badge"></span></h4>
				</div>
			</div>
            <?php if($tot_rows > 0)	{ ?>
            <div class="row-fluid">
			<table class="table table-bordered table-condensed table-striped" id="tab_usr" style="text-align:center">
				...
				<tbody >
					...
					<tr>
						<td>
                            <div class="btn-group">
                        		<a href="<?php echo $RUTAm; ?>tra_pendientes/form.php?per_id=<?php echo $row['per_id']; ?>&accion=Ver" class="btn btn-primary btn-mini"><i class="icon-folder-open"></i> Ver Historial</a>
                        	</div>
						</td>
